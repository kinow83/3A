<template>
    <div :class="['layout-sidebar', {'active': active}]">
        <div class="layout-menu">
            ...
            <div class="menu-items">
                <router-link to="/nas">Nas</router-link>
            </div>
            <div class="menu-category">Log</div>
            <div class="menu-items">
                <router-link to="/radauthlog">Authenticate Log</router-link>
                <router-link to="/onlinelog">Online Log</router-link>
                <router-link to="/radacctlog">Account Log</router-link>
            </div>
            ...
            <div class="menu-items">
                ...
                <router-link to="/oui">OUI</router-link>
            </div>
