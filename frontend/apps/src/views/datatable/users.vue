                ...
                <DataTable :value="users" v-model:expandedRows="expandedRows" dataKey="user_id" class="p-datatable-sm" 
                    ...
                    <template #expansion="slotProps">
                        <div class="orders-subtable">
                            ...
                            <div class="p-text-left">Created: {{slotProps.data.created}}</div>
                            <div class="p-text-left">changed: {{slotProps.data.changed}}</div>
                            <div class="p-text-left">email: {{slotProps.data.email}}</div>
                            <div class="p-text-left">last_login: {{slotProps.data.last_login}}</div>
