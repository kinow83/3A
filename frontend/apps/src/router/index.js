...
const routes = [
    ...
    },
    {
        path: '/users',
        name: 'users',
        component: () => import('../views/datatable/users.vue')
    },
    {
        path: '/groups',
        name: 'groups',
        component: () => import('../views/datatable/groups.vue')
    },
    {
        path: '/nas',
        name: 'nas',
        component: () => import('../views/datatable/nas.vue')
    },
    {
        path: '/radauthlog',
        name: 'radauthlog',
        component: () => import('../views/datatable/radauthlog.vue')
    },
    {
        path: '/onlinelog',
        name: 'onlinelog',
        component: () => import('../views/datatable/onlinelog.vue')
    },
    {
        path: '/radacctlog',
        name: 'radacctlog',
        component: () => import('../views/datatable/radacctlog.vue')
    },
    {
        path: '/config',
        name: 'config',
        component: () => import('../views/datatable/config.vue')
    },
    {
        path: '/proxy',
        name: 'proxy',
        component: () => import('../views/datatable/proxy.vue')
    },
    {
        path: '/integration',
        name: 'integration',
        component: () => import('../views/datatable/integration.vue')
    },
    {
        path: '/oui',
        name: 'oui',
        component: () => import('../views/datatable/oui.vue')
    },
    {
        path: '/setup',
        name: 'setup',
